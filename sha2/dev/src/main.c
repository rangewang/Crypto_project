...
int sha2_224_test(void)
{
    ...
    printf("Test - SHA-224 FIPS 180-4 length=0 bytes...");
    hal_sha2(data, 0, hash_result, 224);
    ...
    printf("Test - SHA-224 FIPS 180-4 length=3 bytes...");
    hal_sha2(data, 3, hash_result, 224);
    if (!sec_compare(hash_result, golden, 28))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-224 FIPS 180-4 length=56 bytes...");
    hal_sha2(data, 56, hash_result, 224);
    if (!sec_compare(hash_result, golden, 28))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-224 FIPS 180-4 length=112 bytes...");
    hal_sha2(data, 112, hash_result, 224);
    if (!sec_compare(hash_result, golden, 28))
        printf("pass\n");
    else
        printf("fail\n");
...
int sha2_256_test(void)
{
    ...
    printf("Test - SHA-256 FIPS 180-4 length=0 bytes...");
    hal_sha2(data, 0, hash_result, 256);
    ...
    printf("Test - SHA-256 FIPS 180-4 length=3 bytes...");
    hal_sha2(data, 3, hash_result, 256);
    if (!sec_compare(hash_result, golden, 0x20))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-256 FIPS 180-4 length=56 bytes...");
    hal_sha2(data, 56, hash_result, 256);
    if (!sec_compare(hash_result, golden, 0x20))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-256 FIPS 180-4 length=112 bytes...");
    hal_sha2(data, 112, hash_result, 256);
    if (!sec_compare(hash_result, golden, 0x20))
        printf("pass\n");
    else
        printf("fail\n");
...
int sha2_384_test(void)
{
    ...
    printf("Test - SHA-384 FIPS 180-4 length=0 bytes...");
    hal_sha2(data, 0, hash_result, 384);
    ...
    printf("Test - SHA-384 FIPS 180-4 length=3 bytes...");
    hal_sha2(data, 3, hash_result, 384);
    if (!sec_compare(hash_result, golden, 0x30))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-384 FIPS 180-4 length=56 bytes...");
    hal_sha2(data, 56, hash_result, 384);
    if (!sec_compare(hash_result, golden, 0x30))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-384 FIPS 180-4 length=112 bytes...");
    hal_sha2(data, 112, hash_result, 384);
    if (!sec_compare(hash_result, golden, 0x30))
        printf("pass\n");
    else
        printf("fail\n");
...
int sha2_512_test(void)
{
    ...
    printf("Test - SHA-512 FIPS 180-4 length=0 bytes...");
    hal_sha2(data, 0, hash_result, 512);
    ...
    printf("Test - SHA-512 FIPS 180-4 length=3 bytes...");
    hal_sha2(data, 3, hash_result, 512);
    if (!sec_compare(hash_result, golden, 0x40))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-512 FIPS 180-4 length=56 bytes...");
    hal_sha2(data, 56, hash_result, 512);
    if (!sec_compare(hash_result, golden, 0x40))
        printf("pass\n");
    else
        printf("fail\n");
    ...
    printf("Test - SHA-512 FIPS 180-4 length=112 bytes...");
    hal_sha2(data, 112, hash_result, 512);
    if (!sec_compare(hash_result, golden, 0x40))
        printf("pass\n");
    else
        printf("fail\n");
